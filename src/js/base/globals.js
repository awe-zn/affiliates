...
class Variables {
  ...
  _initVariables() {
    ...
    Globals.separatorLight = rootStyle
      .getPropertyValue('--separator-light')
      .trim();

    Globals.transitionTimeShort = rootStyle
      .getPropertyValue('--transition-time-short')
      .trim()
      .replace('ms', '');
    Globals.transitionTime = rootStyle
    ...
    Globals.quaternaryrgb = rootStyle
      .getPropertyValue('--quaternary-rgb')
      .trim();

    Globals.borderRadiusXl = rootStyle
      .getPropertyValue('--border-radius-xl')
      .trim();
    Globals.borderRadiusLg = rootStyle
      .getPropertyValue('--border-radius-lg')
      .trim();
    Globals.borderRadiusMd = rootStyle
      .getPropertyValue('--border-radius-md')
      .trim();
    Globals.borderRadiusSm = rootStyle
