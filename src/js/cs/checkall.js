...
class Checkall {
  ...
  _addListeners() {
    ...
    this._button.querySelector('input') &&
      this._button
        .querySelector('input')
        .addEventListener('change', this._onCheckChange);
  ...
  _checkAllRows() {
    this._contentContainer
      .querySelectorAll(this.settings.itemSelector)
      .forEach((el) => {
        el.classList.add(this.settings.selectedClass);
      });
    this._contentContainer
      .querySelectorAll(this.settings.itemSelector + ' .form-check input')
      .forEach((el) => {
        el.checked = true;
      });
  }
  ...
  _removeListeners() {
    ...
    this._button
      .querySelector('input')
      .removeEventListener('change', this._onCheckChange);
