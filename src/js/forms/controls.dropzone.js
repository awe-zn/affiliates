 ...
 * DropzoneControls
 *
 * Interface.Forms.Controls.Dropzone.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class DropzoneControls {
  ...
  _initSingleImageUpload() {
    if (
      typeof SingleImageUpload !== 'undefined' &&
      document.getElementById('singleImageUploadExample')
    ) {
    ...
    if (document.querySelector('#dropzoneServerFiles')) {
      new Dropzone('#dropzoneServerFiles', {
        ...
        init: function () {
          ...
          let mockFile1 = {name: 'bread.jpg', size: 12842};
          this.displayExistingFile(
            mockFile1,
            'img/product/small/product-1.jpg',
          );

          // Setting extra type parameter to show icon instead of thumbnail. It still needs to have a image for some reason.
          let mockFile2 = {name: 'cake.jpg', size: 22354};
          this.displayExistingFile(
            mockFile2,
            'img/product/small/product-2.jpg',
          );
