 ...
 * TimePickerControls
 *
 * Interface.Forms.Controls.TimePicker.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class TimePickerControls {
  ...
  _initTimePickerFilled() {
    if (document.querySelector('#timePickerFilled')) {
      new TimePicker(document.querySelector('#timePickerFilled'), {
        dropdownClassname: 'time-filled-dropdown',
      });
    }
  }
  ...
  _initTimePickerTopLabel() {
    if (document.querySelector('#timePickerTopLabel')) {
      new TimePicker(document.querySelector('#timePickerTopLabel'), {
  ...
  _initTimePickerFloatingLabel() {
    if (document.querySelector('#timePickerFloatingLabel')) {
      new TimePicker(document.querySelector('#timePickerFloatingLabel'), {
        dropdownClassname: 'time-top-label-dropdown',
      });
    }
  }
