 ...
 * RatingControls
 *
 * Interface.Forms.Controls.Rating.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class RatingControls {
  ...
  _initCSLineIconRating() {
    ...
    jQuery('#ratingCSIconReadonly').barrating({
      ...
      showSelectedRating: jQuery('#ratingCSIconReadonly').data(
        'showSelectedRating',
      ),
    });
  }
  ...
  _initCSSIconRating() {
    ...
    jQuery('#ratingCSSIconReadonly').barrating({
      ...
      showSelectedRating: jQuery('#ratingCSSIconReadonly').data(
        'showSelectedRating',
      ),
    });
  }
  ...
  _initTenPointsRating() {
    ...
    jQuery('#ratingTenPointsReadonly').barrating({
      ...
      showSelectedRating: jQuery('#ratingTenPointsReadonly').data(
        'showSelectedRating',
      ),
    });
  }
  ...
  _initBarsTallRating() {
    ...
    jQuery('#barsTallReadonly').barrating({
      ...
      showSelectedRating: jQuery('#barsTallReadonly').data(
        'showSelectedRating',
      ),
    });
  }
  ...
  _initButtonsRating() {
    jQuery('#ratingButtonInteractive').barrating({
      ...
      showSelectedRating: jQuery('#ratingButtonInteractive').data(
        'showSelectedRating',
      ),
    });
    ...
    jQuery('#ratingButtonReadonly').barrating({
      ...
      showSelectedRating: jQuery('#ratingButtonReadonly').data(
        'showSelectedRating',
      ),
    });
  }
