 ...
 * TagControls
 *
 * Interface.Forms.Controls.Tags.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class TagControls {
  ...
  _initUsersListTags() {
    if (document.querySelector('#usersListTags')) {
      ...
      var tagifyUserList = new Tagify(
        document.querySelector('#usersListTags'),
        {
          enforceWhitelist: true,
          ...
          whitelist: [
            {
              ...
              avatar: 'img/profile/profile-1.jpg',
              email: 'jhattersley0@ucsd.edu',
            },
            {
              value: 2,
              name: 'Antons Esson',
              avatar: 'img/profile/profile-2.jpg',
              email: 'aesson1@ning.com',
            },
            {
              value: 3,
              name: 'Ardeen Batisse',
              avatar: 'img/profile/profile-3.jpg',
              email: 'abatisse2@nih.gov',
            },
            {
              value: 4,
              name: 'Graeme Yellowley',
              avatar: 'img/profile/profile-4.jpg',
              email: 'gyellowley3@behance.net',
            },
            {
              value: 5,
              name: 'Dido Wilford',
              avatar: 'img/profile/profile-5.jpg',
              email: 'dwilford4@jugem.jp',
            },
            {
              value: 6,
              name: 'Celesta Orwin',
              avatar: 'img/profile/profile-6.jpg',
              email: 'corwin5@meetup.com',
            },
            {
              value: 7,
              name: 'Sally Main',
              avatar: 'img/profile/profile-7.jpg',
              email: 'smain6@techcrunch.com',
            },
            {
              value: 8,
              name: 'Grethel Haysman',
              avatar: 'img/profile/profile-8.jpg',
  ...
  _initTagsAdvanced() {
    if (document.querySelector('#tagsAdvanced')) {
      ...
      document
        ...
        .addEventListener(
          'click',
          tagifyAdvanced.removeAllTags.bind(tagifyAdvanced),
        );
      ...
      function onInput(e) {
        ...
        mockAjax().then(function (result) {
          ...
          tagifyAdvanced.settings.whitelist.push(
            ...result,
            ...tagifyAdvanced.value,
          );
          ...
          tagifyAdvanced
            .loading(false)
            .dropdown.show.call(tagifyAdvanced, e.detail.value);
        });
      }
