...
class GenericForms {
    ...
    form.addEventListener('submit', (event) => {
      ...
      if (jQuery(form).valid()) {
        const formValues = {
          ...
          contactDepartment: form.querySelector('[name="contactDepartment"]')
            .value,
    ...
    form.addEventListener('submit', (event) => {
      ...
      if (jQuery(form).valid()) {
        const formValues = {
          ...
          personalBirthday: form.querySelector('[name="personalBirthday"]')
            .value,
          personalSocialSecurityNumber: form.querySelector(
  ...
  _initAddress() {
    ...
    form.addEventListener('submit', (event) => {
      ...
      if (jQuery(form).valid()) {
        const formValues = {
          addressFirstName: form.querySelector('[name="addressFirstName"]')
            .value,
  ...
  _initReservation() {
    ...
    form.addEventListener('submit', (event) => {
      ...
      if (jQuery(form).valid()) {
        const formValues = {
          reservationCheckIn: form.querySelector('[name="reservationCheckIn"]')
            .value,
          reservationCheckOut: form.querySelector(
            '[name="reservationCheckOut"]',
          ).value,
          reservationRoom: form.querySelector('[name="reservationRoom"]').value,
          reservationAdults: form.querySelector('[name="reservationAdults"]')
            .value,
          reservationChildren: form.querySelector(
