...
class Notifies {
  ...
  _initImage() {
    jQuery('#notifyButtonImage').on('click', (event) => {
      event.preventDefault();
      jQuery.notify(
        {title: 'Hello World!', message: '', icon: 'img/profile/profile-1.jpg'},
      ...
      jQuery.notify(
        {
          ...
          message:
            'Acorn is created by <a href="https://themeforest.net/user/coloredstrategies" target="_blank">ColoredStrategies</a>',
        },
        {type: 'primary', icon_type: 'image'},
      );
    });
