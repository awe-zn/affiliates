...
class Lists {
  ...
  _initExistingHtmlList() {
    if (document.getElementById('existingHtmlList')) {
      var existingHtmlList = new List('existingHtmlList', {
  ...
  _initExistingHtmlListScrollbar() {
    if (document.getElementById('existingHtmlListScrollbar')) {
      ...
      var existingHtmlListScrollbar = new List('existingHtmlListScrollbar', {
        valueNames: ['name', 'position'],
        listClass: 'os-content',
      });
    }
  }
  ...
  _initAddingViaJS() {
    if (document.getElementById('addingViaJS')) {
      ...
      var values = [
        {
          name: 'Peg Bread',
          image: 'img/product/small/product-1.jpg',
        },
        {
          name: 'Tunnbröd',
          image: 'img/product/small/product-2.jpg',
        },
        {
          name: 'Samoon',
          image: 'img/product/small/product-3.jpg',
        },
        {
          name: 'Rieska',
          image: 'img/product/small/product-4.jpg',
        },
      ];
  ...
  _initSortAndFilter() {
    if (document.getElementById('sortAndFilter')) {
      var sortAndFilter = new List('sortAndFilter', {
    ...
    function filterCategory() {
      ...
      document
        .querySelectorAll('#sortAndFilter .filter:checked')
        .forEach((el) => {
