...
class ProgressBars {
  ...
  _initProgressCircle() {
    ...
    if (document.querySelector('#progressCircleAnimated')) {
      new ProgressBar.Circle(
        document.querySelector('#progressCircleAnimated'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 75,
  ...
  _initProgressSemiCircle() {
    ...
    if (document.querySelector('#progressSemiCircleAnimated')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressSemiCircleAnimated'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 75,
    ...
    if (document.querySelector('#progressSemiCirclePercent')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressSemiCirclePercent'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 75,
    ...
    if (document.querySelector('#progressSemiCircleValue')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressSemiCircleValue'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 15,
  ...
  _initProgressSquare() {
    ...
    if (document.querySelector('#progressSquareAnimated')) {
      new ProgressBar.Square(
        document.querySelector('#progressSquareAnimated'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 75,
  ...
  _initProgressColors() {
    if (document.querySelector('#progressColorsPrimary')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressColorsPrimary'),
        {
          color: Globals.primary,
          trailColor: Globals.separator,
          val: 75,
    ...
    if (document.querySelector('#progressColorsSecondary')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressColorsSecondary'),
        {
    ...
    if (document.querySelector('#progressColorsTertiary')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressColorsTertiary'),
        {
    ...
    if (document.querySelector('#progressColorsQuaternary')) {
      new ProgressBar.SemiCircle(
        document.querySelector('#progressColorsQuaternary'),
        {
