...
class Charts {
  ...
  _initRoundedBarChart() {
    if (document.getElementById('roundedBarChart')) {
      const barChart = document
        .getElementById('roundedBarChart')
        .getContext('2d');
  ...
  _initStreamingLineChart() {
    if (document.getElementById('streamingLineChart')) {
      const streamingLineChart = document
        .getElementById('streamingLineChart')
        .getContext('2d');
  ...
  _initStreamingBarChart() {
    if (document.getElementById('streamingBarChart')) {
      const streamingBarChart = document
        .getElementById('streamingBarChart')
        .getContext('2d');
  ...
  _initCustomTooltipDoughnut() {
    if (document.getElementById('verticalTooltipChart')) {
      var ctx = document
        .getElementById('verticalTooltipChart')
        .getContext('2d');
        ...
        options: {
          ...
          tooltips: {
            ...
            custom: function (tooltip) {
              var tooltipEl = this._chart.canvas.parentElement.querySelector(
                '.custom-tooltip',
              );
              ...
              if (tooltip.body) {
                ...
                iconContainer.style =
                  ...
                  '!important';
                tooltipEl.querySelector('.text').innerHTML = chart._data.labels[
                  index
                ].toLocaleUpperCase();
                tooltipEl.querySelector('.value').innerHTML =
                  chart._data.datasets[0].data[index];
              }
          ...
          tooltips: {
            ...
            custom: function (tooltip) {
              ...
              if (tooltip.body) {
                ...
                icon.setAttribute(
                  'data-cs-icon',
                  chart._data.datasets[datasetIndex].icon,
                );
                csicons.replace();
                tooltipEl.querySelector(
                  '.text',
                ).innerHTML = chart._data.datasets[
                  datasetIndex
                ].label.toLocaleUpperCase();
                tooltipEl.querySelector('.value').innerHTML =
                  chart._data.datasets[datasetIndex].data[index];
              }
              var positionY = this._chart.canvas.offsetTop;
              var positionX = this._chart.canvas.offsetLeft;
              tooltipEl.style.opacity = 1;
              tooltipEl.style.left =
                positionX + tooltip.dataPoints[0].x - 75 + 'px';
              tooltipEl.style.top = positionY + tooltip.caretY + 'px';
            },
          },
        },
      ...
      this._customLegendBar = new Chart(ctx, {
        ...
        options: {
          ...
          legendCallback: function (chart) {
            const legendContainer = chart.canvas.parentElement.parentElement.querySelector(
              '.custom-legend-container',
            );
            legendContainer.innerHTML = '';
            const legendItem = chart.canvas.parentElement.parentElement.querySelector(
              '.custom-legend-item',
            );
            for (let i = 0; i < chart.data.datasets.length; i++) {
              var itemClone = legendItem.content.cloneNode(true);
              var total = chart.data.datasets[i].data.reduce(function (
                total,
                num,
              ) {
                return total + num;
              });
              itemClone.querySelector('.text').innerHTML = chart.data.datasets[
                i
              ].label.toLocaleUpperCase();
              itemClone.querySelector('.value').innerHTML = total;
              itemClone.querySelector('.value').style =
                'color: ' + chart.data.datasets[i].borderColor + '!important';
              itemClone.querySelector('.icon-container').style =
                'border-color: ' +
                chart.data.datasets[i].borderColor +
                '!important';
              itemClone.querySelector('.icon').style =
                'color: ' + chart.data.datasets[i].borderColor + '!important';
              itemClone
                .querySelector('.icon')
                .setAttribute('data-cs-icon', chart.data.icons[i]);
              itemClone
                .querySelector('a')
          ...
          tooltips: {
            ...
            custom: function (tooltip) {
              ...
              if (tooltip.body) {
                ...
                icon.setAttribute(
                  'data-cs-icon',
                  chart._data.icons[datasetIndex],
                );
                csicons.replace();
                tooltipEl.querySelector(
                  '.text',
                ...
                tooltipEl.querySelector('.value').innerHTML =
                  chart._data.datasets[datasetIndex].data[index];
                tooltipEl.querySelector('.value').style =
                  'color: ' + tooltip.labelColors[0].borderColor + ';';
              }
              var positionY = this._chart.canvas.offsetTop;
              var positionX = this._chart.canvas.offsetLeft;
        ...
        options: {
          ...
          legendCallback: function (chart) {
            ...
            for (let i = 0; i < chart.data.datasets[0].data.length; i++) {
              var itemClone = legendItem.content.cloneNode(true);
              itemClone.querySelector('.text').innerHTML = chart.data.labels[
                i
              ].toLocaleUpperCase();
