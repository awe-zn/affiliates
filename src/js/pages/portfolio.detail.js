 ...
 * PortfolioDetail
 *
 * Pages.Portfolio.Detail.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class PortfolioDetail {
  ...
  _initDetailImageCarousel() {
    if (
      document.querySelector('#glidePortfolioDetail') !== null &&
      typeof GlideGallery !== 'undefined'
    ) {
      const element = document.querySelector('#glidePortfolioDetail');
      const glideLength = element.querySelector('.glide-large .glide__slides')
        .children.length;
