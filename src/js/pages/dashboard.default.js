...
class DashboardDefault {
  ...
  _initStatsCarousel() {
    if (
      document.querySelector('#statsCarousel') !== null &&
      typeof GlideCustom !== 'undefined'
    ) {
      new GlideCustom(
  ...
  _initVideoGuidePlayer() {
    if (
      document.querySelector('#videoGuide') !== null &&
  ...
  _initTour() {
    if (
      typeof introJs !== 'undefined' &&
      document.getElementById('dashboardTourButton') !== null
    ) {
      document
