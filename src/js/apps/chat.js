...
class Chat {
  ...
  _renderContact(contact, container) {
    var itemClone = this.listItemTemplate.content
      .cloneNode(true)
      .querySelector('a');
    ...
    this.userProfileTabs
      ...
      .forEach((element) => {
        ...
        if (
          ...
          parseInt(this.currentChatData.id)
        ) {
  ...
  _renderChatMessage(chat, container) {
    ...
    if (chat.type === 'response') {
      ...
      containerClone = this.respondContainerTemplate.content
        .cloneNode(true)
        .querySelector('div');
      containerClone
        ...
        .setAttribute('src', this.currentChatData.thumb);
      if (chat.text !== '') {
        itemClone = this.respondTextContentTemplate.content
          .cloneNode(true)
          .querySelector('div');
        ...
        chat.attachments.map((attachment) => {
          itemClone = this.respondAttachmentContentTemplate.content
            .cloneNode(true)
            .querySelector('div');
          itemClone
            .querySelector('.attachment img')
            .setAttribute('src', attachment);
          itemClone
            .querySelector('.attachment')
            .setAttribute('href', attachment);
          containerClone.querySelector('.content-container').append(itemClone);
          container.append(containerClone);
        });
      }
      ...
      containerClone = this.messageContainerTemplate.content
        .cloneNode(true)
        .querySelector('div');
      if (chat.text !== '') {
        itemClone = this.messageTextContentTemplate.content
          .cloneNode(true)
          .querySelector('div');
        itemClone.querySelector('.text').innerHTML = chat.text;
        itemClone.querySelector('.time').innerHTML = chat.time;
        ...
        chat.attachments.map((attachment) => {
          itemClone = this.messageAttachmentContentTemplate.content
            .cloneNode(true)
            .querySelector('div');
          itemClone
            .querySelector('.attachment img')
